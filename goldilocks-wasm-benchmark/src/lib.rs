...
pub fn benchmark_goldilocks_multiplication() -> f64 {
    ...
    log!("Goldilocks multiplication: 1,000,000 ops in {:.3}ms", duration_ms);
    duration_ms
}
...
pub fn benchmark_goldilocks_monty_multiplication() -> f64 {
    ...
    let duration_ms = end - start;
    log!("Goldilocks Monty multiplication: 1,000,000 ops in {:.3}ms", duration_ms);
    duration_ms
}
...
pub fn benchmark_goldilocks_monty_addition() -> f64 {
    ...
    let duration_ms = end - start;
    log!("Goldilocks Monty addition: 1,000,000 ops in {:.3}ms", duration_ms);
    duration_ms
}
