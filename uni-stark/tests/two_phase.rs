//! TWO phase Fib-like Air circuit
...
use p3_uni_stark::{StarkConfig, prove, prove_two_phases, verify};
use rand::SeedableRng;
use rand::rngs::SmallRng;

/// For testing the public values feature
///
/// | main trace  |  aux trace  |
/// | col1 | col2 | col3 | col4 |
...
fn test_public_value_impl(n: usize, x: u64, log_final_poly_len: usize) {
    ...
    let aux_trace = generate_trace_rows::<Val>(3, 4, n);
    ...
    let proof = prove_two_phases(&config, &FibonacciAir {}, trace, aux_trace, 0, &pis);
    println!("proof: main trace: {:?}", proof.commitments.trace);
    println!("proof: aux trace: {:?}", proof.commitments.aux_trace);
